    ...
    private Dictionary<string, AssetDefinition> InitializeAssets()
    {
        return new Dictionary<string, AssetDefinition>
        {
            ...
            ["emas"] = new AssetDefinition
            {
                ...
                // Light Mode (Kids) - Stoic Orangutan voice
                Description = "Logam berharga yang nilainya bertahan lama.",
                DescriptionEN = "Precious metal that holds value for ages.",
                WhatIsIt = "Emas itu harta karun sejak zaman dulu. Semua orang di dunia menghargai emas. Nilainya bertahan ribuan tahun. Orangutan bilang: emas itu seperti pohon tua yang kuat — tumbuh pelan tapi kokoh.",
                WhatIsItEN = "Gold has been treasure since ancient times. Everyone in the world values gold. Its worth lasts thousands of years. Orangutan says: gold is like an old strong tree — grows slowly but stands firm.",
                RiskExplanation = "Cukup aman. Harga naik turun pelan, tidak secepat saham. Orangutan suka emas.",
                RiskExplanationEN = "Pretty safe. Prices move gently, not as fast as stocks. Orangutan likes gold.",
                BestFor = "Yang sabar. Emas cocok disimpan lama.",
                BestForEN = "For the patient. Gold is best kept for a long time.",
                ExpectedReturn = "Naik 8-15% per tahun kalau sabar. Kadang turun sedikit.",
                ExpectedReturnEN = "Grows 8-15% per year if patient. Sometimes dips a little.",
                // Normal Mode (Adult) - Full details with regulations
            ...
            ["crypto"] = new AssetDefinition
            {
                ...
                // Light Mode (Kids) - Stoic Orangutan voice
                Description = "Uang digital. Sangat berisiko.",
                DescriptionEN = "Digital money. Very risky.",
                WhatIsIt = "Crypto itu uang digital di internet. Nilainya berubah sangat cepat. Bisa naik banyak, bisa turun banyak. Orangutan bilang: ini bukan untuk yang tidak siap kehilangan uangnya.",
                WhatIsItEN = "Crypto is digital money on the internet. Its value changes very fast. Can go way up, can go way down. Orangutan says: this is not for those who can't afford to lose.",
                RiskExplanation = "Sangat berisiko. Bisa naik 2x atau turun 80% dalam sebulan. Tidak ada perlindungan. Orangutan mengingatkan: hati-hati.",
                RiskExplanationEN = "Very risky. Can double or drop 80% in a month. No protection. Orangutan reminds you: be careful.",
                BestFor = "Hanya untuk uang lebih yang siap hilang. Orangutan serius.",
                BestForEN = "Only for extra money you're ready to lose. Orangutan is serious.",
                ExpectedReturn = "Bisa untung sangat besar, bisa juga hilang semua. Pikir baik-baik.",
                ExpectedReturnEN = "Can profit hugely, can also lose everything. Think carefully.",
                // Normal Mode (Adult) - Full details with regulations
            ...
            ["crowdfunding"] = new AssetDefinition
            {
                ...
                // Light Mode (Kids) - Stoic Orangutan voice
                Description = "Patungan modal untuk bisnis kecil.",
                DescriptionEN = "Pool money to help small businesses.",
                WhatIsIt = "Urun Dana itu patungan banyak orang untuk modal bisnis kecil. Kalau sukses, kamu dapat bagian untung. Tapi banyak yang gagal. Orangutan bilang: bantu sesama itu baik, tapi siapkan hati juga.",
                WhatIsItEN = "Crowdfunding is pooling money to fund small businesses. If it works, you share the profit. But many fail. Orangutan says: helping others is good, but prepare your heart too.",
                RiskExplanation = "Berisiko tinggi. Banyak bisnis baru gagal. Uangmu bisa hilang semua. Orangutan mengingatkan: pikir dulu.",
                RiskExplanationEN = "High risk. Many new businesses fail. You can lose everything. Orangutan reminds: think first.",
                BestFor = "Yang mau bantu bisnis lokal dan siap jika uangnya hilang.",
                BestForEN = "For those who want to help local business and accept the risk.",
                ExpectedReturn = "Kalau sukses, untung besar. Tapi banyak yang gagal. Hati-hati.",
                ExpectedReturnEN = "If successful, big profit. But many fail. Be careful.",
                // Normal Mode (Adult) - Full details with regulations
    ...
    private List<RandomEvent> InitializeEvents()
    {
        return new List<RandomEvent>
        {
            new RandomEvent
            {
                ...
                Description = "Keluarga ada yang sakit. Harus ke dokter. Orangutan bilang: ini sebabnya kita selalu siapkan uang cadangan.",
                ...
                DescriptionEN = "A family member is sick. Need to see a doctor. Orangutan says: this is why we always keep backup money.",
            ...
            new RandomEvent
            {
                Title = "Kendaraan Rusak",
                TitleAdult = "Perbaikan Kendaraan",
                Description = "Motor atau mobil tiba-tiba rusak. Harus ke bengkel. Orangutan bilang: tenang, ini hal biasa. Yang penting kita siap.",
                DescriptionAdult = "Kerusakan besar pada kendaraan yang membutuhkan biaya perbaikan signifikan.",
                TitleEN = "Vehicle Broke Down",
                TitleAdultEN = "Vehicle Repair",
                DescriptionEN = "Your vehicle suddenly broke down. Need to visit the mechanic. Orangutan says: stay calm, this is normal. What matters is we're prepared.",
            ...
            new RandomEvent
            {
                ...
                Description = "Hujan deras dan atap bocor. Harus segera diperbaiki. Orangutan bilang: rumah yang kuat perlu perawatan.",
                DescriptionAdult = "Kerusakan atap yang membutuhkan perbaikan segera saat musim hujan.",
                TitleEN = "Leaky Roof",
                TitleAdultEN = "Home Repair",
                DescriptionEN = "Heavy rain and the roof leaks. Must be fixed soon. Orangutan says: a strong home needs care.",
            ...
            new RandomEvent
            {
                ...
                Description = "Naik kelas! Harus bayar biaya sekolah dan seragam baru. Orangutan bilang: pendidikan itu investasi terbaik.",
                DescriptionAdult = "Biaya sekolah dan seragam baru untuk tahun ajaran baru.",
                TitleEN = "School Time",
                TitleAdultEN = "Education Expenses",
                DescriptionEN = "Moving up a grade! Need to pay school fees and new uniforms. Orangutan says: education is the best investment.",
            ...
            new RandomEvent
            {
                ...
                Description = "Waktunya bayar pajak. Orangutan bilang: warga yang baik selalu membayar pajak. Ini tanggung jawab kita.",
                DescriptionAdult = "Ditemukan kekurangan bayar pajak tahunan saat pelaporan.",
                TitleEN = "Tax Time",
                TitleAdultEN = "Tax Payment",
                DescriptionEN = "Time to pay taxes. Orangutan says: good citizens always pay taxes. This is our responsibility.",
            ...
            new RandomEvent
            {
                Title = "Musim Kondangan",
                TitleAdult = "Kewajiban Sosial",
                Description = "Banyak teman menikah bulan ini. Harus beli kado dan kasih amplop. Orangutan bilang: berbagi kebahagiaan itu penting.",
                ...
                DescriptionEN = "Many friends getting married this month. Need gifts and cash envelopes. Orangutan says: sharing joy matters.",
            ...
            new RandomEvent
            {
                ...
                Description = "HP jatuh dan rusak. Harus beli baru. Orangutan bilang: barang bisa diganti, yang penting kita belajar lebih hati-hati.",
                ...
                DescriptionEN = "Phone fell and broke. Need a new one. Orangutan says: things can be replaced, what matters is we learn to be more careful.",
            ...
            new RandomEvent
            {
                ...
                Description = "Waktunya bayar iuran RT dan keamanan. Orangutan bilang: menjaga lingkungan itu tanggung jawab bersama.",
                ...
                DescriptionEN = "Time to pay neighborhood fees. Orangutan says: taking care of our community is everyone's job.",
